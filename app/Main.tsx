      ...
      <div className="home space-y-10 pt-10 md:space-y-20">
        ...
        <div className="upcoming-projects alignfull bg-[url(/static/images/moonlit-clouds.jpg)] bg-cover bg-center px-5 pt-10 pb-10 md:bg-fixed md:px-20 md:pt-20 md:pb-30 xl:px-40 xl:pt-40 xl:pb-50">
          ...
          <div className="status-wrapper space-y-8 rounded-xl bg-gray-900/50 px-5 py-10 md:px-10">
            ...
            <div className="h-8 w-full rounded-full bg-gray-100">
              <div className="bg-primary-500 dark:bg-primary-700 flex h-8 w-[85%] items-center justify-center rounded-full p-0.5 text-center leading-none font-semibold text-white uppercase">
                {' '}
                85%
              </div>
            </div>
            ...
            <div className="h-8 w-full rounded-full bg-gray-100">
              <div className="bg-primary-500 dark:bg-primary-700 flex h-8 w-[25%] items-center justify-center rounded-full p-0.5 text-center leading-none font-semibold text-white uppercase">
                {' '}
                25%
              </div>
            </div>
